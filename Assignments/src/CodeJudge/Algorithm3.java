...
public class Algorithm3
{
	...
	else if (a[m-1]>a[m]){return toppoint3(a,i,m-1);}
	else if (a[m]<a[m+1]){return toppoint3(a,m+1,j);}}
		
		else if (m==0&& a[m]>a[m+1]){return m;}
		else if (m==a.length-1 && a[m]>a[m-1]){return m;}
		return 0;
	}
